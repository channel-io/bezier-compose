...
enum class BezierFloatingButtonColor(
    ...
    @Composable
    internal fun getColorSchemes(variant: BezierFloatingButtonVariant): BezierFloatingButtonColorSchemes {
        return when (variant) {
            BezierFloatingButtonVariant.Primary -> primaryColorSchemes
            BezierFloatingButtonVariant.Secondary -> secondaryColorSchemes
        }
    }
}
