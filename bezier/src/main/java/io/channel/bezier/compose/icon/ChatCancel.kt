...
val BezierIcon.ChatCancel: ImageVector
    get() {
        return _chatCancel ?: ImageVector.Builder(
                name = "ChatCancel",
                defaultWidth = 24.dp,
                defaultHeight = 24.dp,
                viewportWidth = 24f,
            ...
            path(
                ...
                lineTo(7.7573f, 14.8284f)
                lineTo(10.5858f, 12.0f)
                lineTo(7.7573f, 9.1716f)
                lineTo(9.1716f, 7.7573f)
                lineTo(12.0f, 10.5858f)
                lineTo(14.8284f, 7.7573f)
                close()
            }
        }.build().also {
            _chatCancel = it
...
private fun ChatCancelIconPreview() {
    Icon(
            ...
            imageVector = BezierIcon.ChatCancel,
