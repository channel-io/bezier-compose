        ...
        override val imageVector: ImageVector
            get() = _keyboardHide ?: ImageVector.Builder(
                ...
                path(
                    ...
                    lineTo(18.0f, 8.0f)
                    close()
                    moveTo(9.33301f, 8.0f)
                    lineTo(11.333f, 8.0f)
                    lineTo(11.333f, 6.0f)
                    lineTo(9.33301f, 6.0f)
                    lineTo(9.33301f, 8.0f)
                    close()
                    moveTo(14.666f, 8.0f)
                    lineTo(12.666f, 8.0f)
                    lineTo(12.666f, 6.0f)
                    ...
                    lineTo(18.0f, 11.0f)
                    close()
                    moveTo(9.33301f, 11.0f)
                    lineTo(11.333f, 11.0f)
                    lineTo(11.333f, 9.0f)
                    lineTo(9.33301f, 9.0f)
                    lineTo(9.33301f, 11.0f)
                    close()
                    ...
                    lineTo(8.0f, 14.0f)
                    close()
                    moveTo(9.39393f, 17.8309f)
                    curveTo(8.8863f, 17.6133f, 8.29842f, 17.8485f, 8.08087f, 18.3561f)
                    curveTo(7.86331f, 18.8637f, 8.09846f, 19.4516f, 8.60609f, 19.6692f)
