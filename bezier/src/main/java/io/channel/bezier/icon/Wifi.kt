...
val BezierIcon.Wifi: ImageVector
    get() {
        return _wifi ?: ImageVector.Builder(
                name = "Wifi",
                defaultWidth = 24.dp,
                defaultHeight = 24.dp,
                viewportWidth = 24f,
            ...
            path(
                ...
                lineTo(6.8418f, 14.5553f)
                curveTo(7.0318f, 14.7558f, 7.3472f, 14.7628f, 7.5607f, 14.5875f)
                curveTo(8.7687f, 13.5955f, 10.3148f, 13.0f, 12.0f, 13.0f)
                ...
                curveTo(22.1469f, 9.2894f, 22.1382f, 8.9405f, 21.9102f, 8.7398f)
                curveTo(19.2674f, 6.412f, 15.7986f, 5.0f, 12.0f, 5.0f)
                curveTo(8.2014f, 5.0f, 4.7326f, 6.412f, 2.0898f, 8.7398f)
                curveTo(1.8618f, 8.9405f, 1.8531f, 9.2894f, 2.062f, 9.5099f)
                lineTo(3.4031f, 10.9255f)
                curveTo(3.5931f, 11.126f, 3.9089f, 11.1337f, 4.117f, 10.9522f)
                curveTo(6.2256f, 9.1136f, 8.9827f, 8.0f, 12.0f, 8.0f)
                curveTo(15.0173f, 8.0f, 17.7744f, 9.1136f, 19.8829f, 10.9522f)
                close()
            }
        }.build().also {
            _wifi = it
