        ...
        override val imageVector: ImageVector
            get() = _headset ?: ImageVector.Builder(
                ...
                path(
                    ...
                    lineTo(16.5f, 18.0f)
                    curveTo(15.673f, 18.0f, 15.0f, 17.326999999999998f, 15.0f, 16.5f)
                    lineTo(15.0f, 11.5f)
                    curveTo(15.0f, 10.673f, 15.673f, 10.0f, 16.5f, 10.0f)
                    lineTo(18.0f, 10.0f)
                    curveTo(18.0f, 6.691f, 15.309000000000001f, 4.0f, 12.0f, 4.0f)
                    curveTo(8.690999999999999f, 4.0f, 6.0f, 6.691f, 6.0f, 10.0f)
                    lineTo(7.5f, 10.0f)
                    curveTo(8.327f, 10.0f, 9.0f, 10.673f, 9.0f, 11.5f)
                    lineTo(9.0f, 16.5f)
                    curveTo(9.0f, 17.326999999999998f, 8.327f, 18.0f, 7.5f, 18.0f)
                    lineTo(6.0f, 18.0f)
                    lineTo(6.0f, 19.0f)
