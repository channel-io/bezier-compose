...
val BezierIcon.Error: ImageVector
    get() {
        return _error ?: ImageVector.Builder(
                name = "Error",
                defaultWidth = 24.dp,
                defaultHeight = 24.dp,
                viewportWidth = 24f,
            ...
            path(
                ...
                close()
                moveTo(3.9997f, 12.0001f)
                curveTo(3.9997f, 7.5907f, 7.5903f, 4.0001f, 11.9997f, 4.0001f)
                curveTo(16.4097f, 4.0001f, 19.9997f, 7.5903f, 19.9997f, 12.0001f)
                curveTo(19.9997f, 16.4099f, 16.4097f, 20.0001f, 11.9997f, 20.0001f)
                curveTo(7.5903f, 20.0001f, 3.9997f, 16.4095f, 3.9997f, 12.0001f)
                close()
