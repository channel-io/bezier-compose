        ...
        override val imageVector: ImageVector
            get() = _headsetOff ?: ImageVector.Builder(
                ...
                path(
                    ...
                    curveTo(22.0f, 14.825000000000001f, 21.48f, 16.987000000000002f, 20.398f, 18.777f)
                    lineTo(21.546f, 19.925f)
                    arcTo(1.0f, 1.0f, 314.0042553864246f, isMoreThanHalf = true, isPositiveArc = true, 20.131999999999998f, 21.339000000000002f)
                    lineTo(2.81f, 4.018f)
                    ...
                    arcTo(3.0f, 3.0f, 227.75455833969744f, isMoreThanHalf = false, isPositiveArc = true, 19.876f, 14.357f)
                    curveTo(19.958000000000002f, 13.817f, 20.0f, 13.264f, 20.0f, 12.706999999999999f)
                    curveTo(20.0f, 10.245f, 19.183f, 7.8679999999999986f, 17.657f, 6.342999999999999f)
                }
            }.build().also {
                _headsetOff = it
            }
