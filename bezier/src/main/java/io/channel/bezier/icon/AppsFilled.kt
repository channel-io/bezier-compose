...
val BezierIcons.AppsFilled: BezierIcon
    get() = object : BezierIcon {
        @DrawableRes
        override val resourceId: Int = R.drawable.icon_apps_filled
        override val imageVector: ImageVector
            get() = _appsFilled ?: ImageVector.Builder(
                ...
                path(
                    ...
                    moveTo(10.0f, 13.0f)
                    arcTo(1.0f, 1.0f, 270.0f, isMoreThanHalf = false, isPositiveArc = true, 11.0f, 14.0f)
                    lineTo(11.0f, 20.0f)
                    arcTo(1.0f, 1.0f, 0.0f, isMoreThanHalf = false, isPositiveArc = true, 10.0f, 21.0f)
                    lineTo(4.0f, 21.0f)
                    arcTo(1.0f, 1.0f, 90.0f, isMoreThanHalf = false, isPositiveArc = true, 3.0f, 20.0f)
                    lineTo(3.0f, 14.0f)
                    arcTo(1.0f, 1.0f, 180.0f, isMoreThanHalf = false, isPositiveArc = true, 4.0f, 13.0f)
                    close()
                    moveTo(20.0f, 13.0f)
