        ...
        override val imageVector: ImageVector
            get() = _splitRightFilled ?: ImageVector.Builder(
                ...
                path(
                    ...
                    lineTo(11.0f, 16.0f)
                    arcTo(1.0f, 1.0f, 180.0f, isMoreThanHalf = false, isPositiveArc = false, 12.0f, 17.0f)
                    lineTo(18.0f, 17.0f)
                    arcTo(1.0f, 1.0f, 90.0f, isMoreThanHalf = false, isPositiveArc = false, 19.0f, 16.0f)
                    lineTo(19.0f, 8.0f)
                    arcTo(1.0f, 1.0f, 0.0f, isMoreThanHalf = false, isPositiveArc = false, 18.0f, 7.0f)
                    close()
                }
            }.build().also {
