        ...
        override val imageVector: ImageVector
            get() = _handThumbupFilled ?: ImageVector.Builder(
                ...
                path(
                    ...
                    lineTo(8.830000000000002f, 8.032f)
                    lineTo(8.628000000000002f, 8.243f)
                    arcTo(6.22f, 6.22f, 222.41645626256027f, isMoreThanHalf = false, isPositiveArc = false, 7.0f, 12.451f)
                    lineTo(7.0f, 13.227f)
                    lineTo(7.005f, 13.483f)
                    arcTo(6.23f, 6.23f, 177.77961590594384f, isMoreThanHalf = false, isPositiveArc = false, 10.929f, 19.031f)
                    arcTo(7.1f, 7.1f, 111.82715928398451f, isMoreThanHalf = false, isPositiveArc = false, 13.573f, 19.54f)
                    lineTo(16.25f, 19.54f)
                    lineTo(16.442f, 19.534f)
                    arcTo(3.26f, 3.26f, 86.48767690539593f, isMoreThanHalf = false, isPositiveArc = false, 19.292f, 17.432f)
                    lineTo(21.542f, 11.431999999999999f)
                    lineTo(21.611f, 11.229f)
                    arcTo(3.22f, 3.22f, 17.064440064133667f, isMoreThanHalf = false, isPositiveArc = false, 21.171f, 8.437999999999999f)
                    lineTo(21.043f, 8.265999999999998f)
                    arcTo(3.22f, 3.22f, 321.73903030126434f, isMoreThanHalf = false, isPositiveArc = false, 18.5f, 7.04f)
                    lineTo(14.77f, 7.04f)
                    ...
                    arcTo(0.5f, 0.5f, 153.04192154516616f, isMoreThanHalf = false, isPositiveArc = false, 3.2729999999999997f, 18.946000000000005f)
                    curveTo(3.38f, 19.0f, 3.52f, 19.0f, 3.8f, 19.0f)
                    lineTo(5.199999999999999f, 19.0f)
                    curveTo(5.4799999999999995f, 19.0f, 5.619999999999999f, 19.0f, 5.726999999999999f, 18.946f)
                    arcTo(0.5f, 0.5f, 62.86825471832731f, isMoreThanHalf = false, isPositiveArc = false, 5.944999999999999f, 18.727f)
