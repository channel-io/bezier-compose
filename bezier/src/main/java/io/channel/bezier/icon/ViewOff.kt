...
val BezierIcons.ViewOff: BezierIcon
    get() = object : BezierIcon {
        @DrawableRes
        override val resourceId: Int = R.drawable.icon_view_off
        override val imageVector: ImageVector
            get() = _viewOff ?: ImageVector.Builder(
                ...
                path(
                    ...
                    curveTo(15.432000000000002f, 8.043000000000001f, 18.298000000000002f, 9.713000000000001f, 20.139000000000003f, 12.560000000000002f)
                    curveTo(20.439000000000004f, 13.023000000000001f, 21.042f, 13.210000000000003f, 21.529000000000003f, 12.951000000000002f)
                    curveTo(22.016000000000002f, 12.691000000000003f, 22.204000000000004f, 12.083000000000002f, 21.910000000000004f, 11.616000000000003f)
                    curveTo(19.704000000000004f, 8.108000000000004f, 16.178000000000004f, 6.043000000000003f, 12.309000000000003f, 6.043000000000003f)
                    curveTo(11.089000000000002f, 6.043000000000003f, 9.914000000000003f, 6.277000000000003f, 8.795000000000003f, 6.674000000000003f)
                    lineTo(4.575000000000004f, 2.4540000000000033f)
                    arcTo(1.0f, 1.0f, 316.7997999659956f, isMoreThanHalf = true, isPositiveArc = false, 3.1620000000000035f, 3.868000000000003f)
                    lineTo(20.132f, 20.839000000000002f)
                    arcTo(1.0f, 1.0f, 135.99574461357543f, isMoreThanHalf = true, isPositiveArc = false, 21.546000000000003f, 19.425f)
                    ...
                    moveTo(3.088f, 12.95f)
                    curveTo(2.601f, 12.690999999999999f, 2.4130000000000003f, 12.082999999999998f, 2.708f, 11.616f)
