        ...
        override val imageVector: ImageVector
            get() = _viewOff ?: ImageVector.Builder(
                ...
                path(
                    ...
                    curveTo(15.432000000000002f, 8.043000000000001f, 18.298000000000002f, 9.713000000000001f, 20.14f, 12.559000000000001f)
                    curveTo(20.44f, 13.023000000000001f, 21.042f, 13.211f, 21.529f, 12.951f)
                    curveTo(22.017f, 12.691f, 22.204f, 12.083f, 21.91f, 11.616f)
                    curveTo(19.704f, 8.108f, 16.178f, 6.042999999999999f, 12.309f, 6.042999999999999f)
                    curveTo(11.088999999999999f, 6.042999999999999f, 9.914f, 6.276999999999999f, 8.795f, 6.6739999999999995f)
                    lineTo(4.575f, 2.4539999999999997f)
                    arcTo(1.0f, 1.0f, 316.7997999659956f, isMoreThanHalf = true, isPositiveArc = false, 3.162f, 3.8679999999999994f)
                    lineTo(20.131999999999998f, 20.839f)
                    arcTo(1.0f, 1.0f, 134.00425538642457f, isMoreThanHalf = false, isPositiveArc = false, 21.546f, 19.424999999999997f)
                    lineTo(16.353f, 14.231999999999998f)
                    curveTo(16.392000000000003f, 14.008999999999997f, 16.416f, 13.780999999999997f, 16.416f, 13.546999999999997f)
