        ...
        override val imageVector: ImageVector
            get() = _coupon ?: ImageVector.Builder(
                ...
                path(
                    ...
                    close()
                    moveTo(9.0f, 8.0f)
                    arcTo(1.0f, 1.0f, 270.0f, isMoreThanHalf = false, isPositiveArc = false, 8.0f, 9.0f)
                    lineTo(8.0f, 15.0f)
                    arcTo(1.0f, 1.0f, 180.0f, isMoreThanHalf = true, isPositiveArc = false, 10.0f, 15.0f)
                    lineTo(10.0f, 9.0f)
                    arcTo(1.0f, 1.0f, 0.0f, isMoreThanHalf = false, isPositiveArc = false, 9.0f, 8.0f)
                }
            }.build().also {
                _coupon = it
            }
