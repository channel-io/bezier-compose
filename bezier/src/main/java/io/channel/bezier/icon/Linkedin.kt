        ...
        override val imageVector: ImageVector
            get() = _linkedin ?: ImageVector.Builder(
                ...
                path(
                    ...
                    lineTo(4.39815f, 3.0f)
                    curveTo(3.62575f, 3.0f, 3.0f, 3.62575f, 3.0f, 4.39815f)
                    lineTo(3.0f, 19.6032f)
                    curveTo(3.0f, 20.3757f, 3.62575f, 21.0014f, 4.39815f, 21.0014f)
                    lineTo(19.6032f, 21.0014f)
                    curveTo(20.3757f, 21.0014f, 21.0014f, 20.3757f, 21.0014f, 19.6032f)
                    lineTo(21.0014f, 4.39815f)
                    curveTo(21.0f, 3.62575f, 20.3743f, 3.0f, 19.6032f, 3.0f)
                    close()
                    moveTo(8.45992f, 18.2987f)
                    lineTo(5.78374f, 18.2987f)
                    lineTo(5.78374f, 9.74913f)
                    lineTo(8.45992f, 9.74913f)
                    lineTo(8.45992f, 18.2987f)
                    close()
                    moveTo(7.11624f, 8.57027f)
                    curveTo(6.26143f, 8.57027f, 5.56864f, 7.87747f, 5.56864f, 7.02266f)
                    curveTo(5.56864f, 6.16784f, 6.26143f, 5.47505f, 7.11624f, 5.47505f)
                    curveTo(7.97106f, 5.47505f, 8.66385f, 6.16784f, 8.66385f, 7.02266f)
                    curveTo(8.66385f, 7.87747f, 7.97106f, 8.57027f, 7.11624f, 8.57027f)
                    close()
                    ...
                    lineTo(10.1221f, 9.74913f)
                    lineTo(12.6656f, 9.74913f)
                    lineTo(12.6642f, 10.9112f)
                    lineTo(12.6739f, 10.9112f)
                    curveTo(12.7103f, 10.8498f, 12.7633f, 10.7981f, 12.7913f, 10.7324f)
                    curveTo(13.5064f, 9.05075f, 16.6589f, 8.98091f, 17.7553f, 10.6151f)
