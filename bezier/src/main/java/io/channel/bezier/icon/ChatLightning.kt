        ...
        override val imageVector: ImageVector
            get() = _chatLightning ?: ImageVector.Builder(
                ...
                path(
                    ...
                    moveTo(14.162f, 6.088f)
                    curveTo(14.377f, 5.872f, 14.739f, 6.086f, 14.653f, 6.378f)
                    lineTo(13.428f, 10.547f)
                    lineTo(15.97f, 11.135f)
                    arcTo(0.295f, 0.295f, 283.36685905669674f, isMoreThanHalf = false, isPositiveArc = true, 16.111f, 11.629999999999999f)
                    lineTo(10.035f, 17.723f)
                    curveTo(9.82f, 17.939f, 9.459f, 17.724999999999998f, 9.545f, 17.432f)
                    lineTo(10.77f, 13.264f)
                    lineTo(8.228f, 12.676f)
                    arcTo(0.295f, 0.295f, 103.20521015384708f, isMoreThanHalf = false, isPositiveArc = true, 8.086f, 12.181000000000001f)
                    close()
                }
            }.build().also {
                _chatLightning = it
