        ...
        override val imageVector: ImageVector
            get() = _star ?: ImageVector.Builder(
                ...
                path(
                    ...
                    lineTo(17.82f, 14.21f)
                    lineTo(21.560000000000002f, 11.492f)
                    curveTo(23.345000000000002f, 10.195f, 22.429000000000002f, 7.372000000000001f, 20.222f, 7.372000000000001f)
                    lineTo(15.597000000000001f, 7.372000000000001f)
                    lineTo(14.168000000000001f, 2.974000000000001f)
                    curveTo(13.488000000000001f, 0.8750000000000009f, 10.517000000000001f, 0.8750000000000009f, 9.836000000000002f, 2.975000000000001f)
                    lineTo(8.406000000000002f, 7.372000000000002f)
                    lineTo(3.782f, 7.372f)
                    curveTo(1.5750000000000002f, 7.372f, 0.6589999999999998f, 10.195f, 2.442f, 11.492f)
                    lineTo(6.184f, 14.21f)
                    lineTo(4.756f, 18.61f)
                    curveTo(4.073f, 20.708f, 6.476f, 22.453f, 8.261f, 21.156f)
                    close()
                    moveTo(12.59f, 16.392f)
                    ...
                    lineTo(8.535f, 13.446000000000002f)
                    lineTo(3.62f, 9.874f)
                    arcTo(0.277f, 0.277f, 125.6799342598602f, isMoreThanHalf = false, isPositiveArc = true, 3.783f, 9.372f)
                    lineTo(9.86f, 9.372f)
                    ...
                    lineTo(15.469f, 13.446000000000002f)
