        ...
        override val imageVector: ImageVector
            get() = _screenshareFilled ?: ImageVector.Builder(
                ...
                path(
                    ...
                    lineTo(6.0f, 4.0f)
                    close()
                    moveTo(7.29289f, 12.7071f)
                    curveTo(6.90237f, 12.3166f, 6.90237f, 11.6834f, 7.29289f, 11.2929f)
                    lineTo(10.5858f, 8.0f)
                    curveTo(11.3668f, 7.21895f, 12.6332f, 7.21895f, 13.4142f, 8.0f)
                    ...
                    lineTo(8.70711f, 12.7071f)
                    curveTo(8.31658f, 13.0976f, 7.68342f, 13.0976f, 7.29289f, 12.7071f)
                    close()
                }
            }.build().also {
