        ...
        override val imageVector: ImageVector
            get() = _shine ?: ImageVector.Builder(
                ...
                path(
                    ...
                    lineTo(7.5f, 16.5f)
                    lineTo(2.5f, 14.228f)
                    arcTo(0.25f, 0.25f, 114.49464847141967f, isMoreThanHalf = false, isPositiveArc = true, 2.5f, 13.773f)
                    lineTo(7.5f, 11.5f)
                    lineTo(9.772f, 6.5f)
                    arcTo(0.25f, 0.25f, 204.21678341329263f, isMoreThanHalf = false, isPositiveArc = true, 10.228f, 6.5f)
                    lineTo(12.5f, 11.5f)
                    lineTo(17.5f, 13.773f)
                    arcTo(0.25f, 0.25f, 294.4946484714196f, isMoreThanHalf = false, isPositiveArc = true, 17.5f, 14.228f)
                    lineTo(12.5f, 16.5f)
                    close()
                }
            }.build().also {
