...
val BezierIcon.CloudUpload: ImageVector
    get() {
        return _cloudUpload ?: ImageVector.Builder(
                name = "CloudUpload",
                defaultWidth = 24.dp,
                defaultHeight = 24.dp,
                viewportWidth = 24f,
            ...
            path(
                ...
                lineTo(8.0f, 17.0f)
                curveTo(8.5523f, 17.0f, 9.0f, 17.4477f, 9.0f, 18.0f)
                curveTo(9.0f, 18.5523f, 8.5523f, 19.0f, 8.0f, 19.0f)
                lineTo(6.25f, 19.0f)
                ...
                curveTo(11.6834f, 9.9024f, 12.3166f, 9.9024f, 12.7071f, 10.2929f)
                ...
                lineTo(8.9314f, 14.5858f)
                curveTo(8.2186f, 14.5858f, 7.8617f, 13.7241f, 8.3657f, 13.2201f)
...
private fun CloudUploadIconPreview() {
    Icon(
            ...
            imageVector = BezierIcon.CloudUpload,
