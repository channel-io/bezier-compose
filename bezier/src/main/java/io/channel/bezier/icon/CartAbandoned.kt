...
val BezierIcons.CartAbandoned: BezierIcon
    get() = object : BezierIcon {
        @DrawableRes
        override val resourceId: Int = R.drawable.icon_cart_abandoned
        override val imageVector: ImageVector
            get() = _cartAbandoned ?: ImageVector.Builder(
                ...
                path(
                    ...
                    arcTo(4.0f, 4.0f, 90.00709751901138f, isMoreThanHalf = false, isPositiveArc = false, 20.290999999999997f, 13.442f)
                    lineTo(20.45f, 12.0f)
                    lineTo(18.436999999999998f, 12.0f)
                    lineTo(18.301999999999996f, 13.22f)
                    arcTo(2.0f, 2.0f, 6.315310200350176f, isMoreThanHalf = false, isPositiveArc = true, 16.315f, 15.0f)
                    lineTo(9.686f, 15.0f)
                    arcTo(2.0f, 2.0f, 89.99608024915372f, isMoreThanHalf = false, isPositiveArc = true, 7.698f, 13.22f)
                    lineTo(7.12f, 8.0f)
                    lineTo(10.0f, 8.0f)
                    lineTo(10.0f, 6.0f)
                    lineTo(6.898f, 6.0f)
